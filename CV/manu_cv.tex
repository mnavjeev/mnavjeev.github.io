...
\definecolor{darkblue}{rgb}{0.0,0.18,0.65}
%\definecolor{darkblue}{rgb}{0.0, 0.28, 0.67}
\hypersetup{colorlinks,breaklinks,
            linkcolor=darkblue,urlcolor=black,
...
\begin{document}
\makeheading{\huge{Manu Navjeevan}}
...
\item[] Ph.D.,
    ...
    % \begin{innerlist}
         % \item[]
    \underline{Advisers}: {Denis Chetverikov (Primary), Andres Santos, Zhipeng Liao}
     % \end{innerlist}
...
\begin{bibenum}
    \item Baybutt, A. and Navjeevan, M. ``\href{https://arxiv.org/abs/2301.06283}{Doubly-Robust Inference for Conditional Average Treatment Effects with High-Dimensional Controls.}'' (\textit{Journal of Econometrics}, 2026)
\end{bibenum}
...
\begin{bibenum}
    ...
    \item Bei, X. and Navjeevan, M. (2026) ``Inference under First-Order Degeneracy.'' 
    \item Navjeevan, M. (2023). ``An Identification and Dimensionality Robust Test for Instrumental Variables Models.'' (\textit{Revise and Resubmit, Journal of Econometrics})

    \item Navjeevan, M., Pinto, R., and Santos, A. (2023). ``Identification in Instrumental Variables Models: The Central Role of Abadie's Kappa.'' (\textit{Conditionally Accepted, Econometrica})

    \item Navjeevan, M. and Pinto, R. (2022) ``\href{https://navjeevan.dev/files/Papers/Ord_Unord_Paper.pdf}{Ordered, Unordered, and Minimal Monotonicity}.''
...
%
\begin{bibenum}
\item Garcia, J., Navjeevan, M., and Xu, H. ``On Placebo Testing.''
\item Chetverikov, D., Navjeevan, M., and Voronin, A. ``Nonparametric Estimation Under Discrete Covariates with Large Support.''
\item Castillo, M., Ige, M., and Navjeevan, M. ``Compliers, defiers and the evaluation of information interventions.''
...
\textbf{Dissertation Year Fellowship}, UCLA Graduate Division

\halfblankline

\textbf{Honors Pass, Econometrics Qualifying Exam}, Department of Economics, UCLA

\halfblankline

\textbf{Honors Pass, Microeconomics Qualifying Exam}, Department of Economics, UCLA
...
\begin{outerlist}
    \item[] \textbf{Econ 471} (Data Science for Future Decision Makers), 2024-2026 
    \item[] \textbf{Econ 676} (Econometrics II), 2025-2026
\end{outerlist}
...
\begin{outerlist}
\item[] \textbf{Econ 103} (Introduction to Econometrics), Summer 2021- 2023. 
    % \begin{innerlist}
